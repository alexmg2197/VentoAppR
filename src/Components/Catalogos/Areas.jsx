...
import ModalAddArea from "../Modal/ModalAddArea";
...
export default function Areas(){
    ...
    const filteredRows = areas.filter((r) => 
        ["nombreArea", "responsableArea"]
        .some((campo) =>
    ...
    return(
            <div className="p-4">
                    {
                    modalEdit && <ModalAddArea modal={setModalEdit} area={area} isEdit={ismodal}/>
                    }
                    <div className="bg-three text-white py-3 rounded-t-xl flex items-center justify-between px-4">
                        <h2 className="text-2xl font-bold text-center flex-1">Areas</h2>
                    ...
                    <div className="flex justify-end bg-three relative pr-5">
                        <div className="relative group">
                            <button onClick={()=>{newArea()}} className="icon-button text-white cursor-pointer">
                    ...
                    <TableContainer>
                        ...
                        <TableBody>
                            ...
                            <TableRow key={area.idArea}>
                                ...
                                <TableCell>{area.responsableArea}</TableCell>
                                <TableCell>
                                <button onClick={()=>{editA(area)}} className='icon-button p-2'><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20"><path fill="currentColor" d="m2.292 13.36l4.523 4.756L.5 20zM12.705 2.412l4.522 4.755L7.266 17.64l-4.523-4.754zM16.142.348l2.976 3.129c.807.848.086 1.613.086 1.613l-1.521 1.6l-4.524-4.757L14.68.334l.02-.019c.119-.112.776-.668 1.443.033"/></svg></button>
                                <button onClick={()=>{deleteA(area)}} className='icon-button'><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 48 48"><defs><mask id="IconifyId19491a687d6412eb80"><g fill="none" strokeLinejoin="round" strokeWidth="4"><path fill="#fff" stroke="#fff" d="M9 10v34h30V10z"/><path stroke="#000" strokeLinecap="round" d="M20 20v13m8-13v13"/><path stroke="#fff" strokeLinecap="round" d="M4 10h40"/><path fill="#fff" stroke="#fff" d="m16 10l3.289-6h9.488L32 10z"/></g></mask></defs><path fill="currentColor" d="M0 0h48v48H0z" mask="url(#IconifyId19491a687d6412eb80)"/></svg></button>
                                </TableCell>
                            </TableRow>
                            ))}
                        </TableBody>
